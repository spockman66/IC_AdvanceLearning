...
#
# Generated by export_simulation on Sun Dec 11 21:46:42 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './dds_1MHz.sh' script.

./dds_1MHz.sh -reset_run
...
./dds_1MHz.sh -noclean_files

For more information on the script, please type './dds_1MHz.sh -help'.
